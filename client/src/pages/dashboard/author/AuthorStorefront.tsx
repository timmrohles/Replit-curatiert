...
export function AuthorStorefront() {
  const [storefronts, setStorefronts] = useState<Storefront[]>([
    {
      id: '1',
      name: 'Meine Romane',
      description: 'Alle meine veröffentlichten Romane in chronologischer Reihenfolge',
      slug: 'meine-romane',
      bookCount: 8,
      views: 3456,
      status: 'published',
    ...
    {
      id: '2',
      name: 'Kurzgeschichten-Sammlung',
      description: 'Meine Kurzgeschichten und Erzählungen',
    ...
    {
      id: '3',
      name: 'Kommende Veröffentlichungen',
      description: 'Vorschau auf meine nächsten Bücher',
      slug: 'coming-soon',
      bookCount: 3,
      views: 0,
      status: 'draft',
